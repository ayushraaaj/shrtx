...
const UrlTableRow = (props: Props) => {
    ...
    const urlDetails = (userId: string) => {
        router.push(`/dashboard/url/${userId}`);
    };

    return (
        <>
            <tr
                className={`group border-b border-zinc-50 hover:bg-zinc-50/80 transition-all duration-500 ease-in-out ${
            ...
            >
                {isBulkAddMode || isBulkRemoveMode ? (
                    ...
                    >
                        <ChevronRightIcon
                            className={`w-4 h-4 text-zinc-400 transition-transform duration-500 ease-in-out ${
            ...
            <tr className={`border-none ${!isExpanded ? "invisible" : ""}`}>
                            ...
                            <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden max-w-4xl">
                                <div className="px-4 py-3 border-b border-zinc-100 bg-zinc-50/50 flex justify-between items-center">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            onClick={() => urlDetails(url._id)}
                                            className="flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-blue-600 rounded-xl text-[11px] font-bold hover:bg-blue-100 transition-all duration-500 active:scale-95 border border-blue-100"
                                        >
                                ...
                                <div className="divide-y divide-zinc-50">
                                    {url.refs.map((ref) => {
                                        ...
                                        return (
                                            <div
                                                key={ref.source}
                                                className="grid grid-cols-12 items-center px-5 py-3 hover:bg-zinc-50/50 transition-colors duration-500"
                                            >
                                                ...
                                                <div className="col-span-3 flex justify-end">
                                                    <button
                                                        ...
                                                        className="px-3 py-1.5 bg-zinc-900 text-white text-[10px] font-bold rounded-lg hover:bg-zinc-800 transition-all duration-500 active:scale-95"
                                                    >
                                                        Copy Link
                                                    </button>
                                                </div>
